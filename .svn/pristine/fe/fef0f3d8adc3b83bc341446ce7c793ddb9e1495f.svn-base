...
(
	...
	u_pw       		varchar(200)not null 			comment '비밀번호',   -- 비밀번호
	...
	u_gender   		varchar(2)	not null			comment '성별',     -- 성별
	u_state    		varchar(2)						comment '관리여부',   -- 관리여부 탈퇴 
	primary key (u_no)
);
...
(
	...
	p_cnt	  int   not null		comment 'PT총회차',    -- PT총회차
