...
<script>
	...
	function findid()
	{
		...
		$.ajax({
			type:'post',
			url:'U-FindidOK.jsp',
			data:{"u_nick":u_nick,"u_email":u_email},
		...
		<ul>
			<li>
				...
				<table style="width:500px; height:300px;">
					...
					<tr>
						<td><input type="text" id="u_nick" class="form-control" placeholder="닉네임" required autofocus></td>
					</tr>
					<tr>
						<td><input type="email" id="u_email" class="form-control" placeholder="이메일" required></td>
					</tr>
					<tr>
			...
			<li>
				<form id="findpw" name="findpw" method="post" action="#">
				<table style="width:500px; height:300px">
					<tr>
						<td style="font-size:20px; font-weight:bold;">PW 찾기<p/></td>
					</tr>
					<tr>
						<td><input type="button" class="btn btn-primary" value="찾기" onclick="DoFindPW()" ></td>
					</tr>
					<tr>
						<td>&nbsp;</td>
					</tr>
