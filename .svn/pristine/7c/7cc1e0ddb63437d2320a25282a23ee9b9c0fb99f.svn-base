...
public class TrainerProfilDAO {
	...
	public VO tProfilDAO(String t_no) 
	{
		String sql = "select t_no,t_id,t_nick,t_phone,t_email,t_major,t_addr1,t_addr2,t_realP,t_originP,t_etc,t_cost1,t_cost2,t_cost3 from trainer where t_no = ?";
	...
	public VO tProfil2DAO(String t_no) 
	{
	...
	public int tProfilUpdateDAO(VO vo)
	{
		...
		{	
			...
			if(vo.getT_realP() != null) //이미지 파일이 있을때 처리
			{
				...
				pstmt.setString(4, vo.getT_etc());
				pstmt.setString(5, vo.getT_cost1());
				pstmt.setString(6, vo.getT_cost2());
				pstmt.setString(7, vo.getT_cost3());
				pstmt.setString(8, vo.getT_id());
